            ...
            <div className="text-sm text-slate-200">
                ...
                <div className="grid grid-cols-2 gap-2 bg-slate-900/50 p-2 rounded text-xs">
                    <div>
                        ...
                        <span className="text-cyan-400 font-bold">{qty} un</span>
                        <span className="text-slate-400 ml-1">({boxes} cx)</span>
                    </div>
                    <div>
  ...
  return (
    <div className="w-80 h-full bg-[#0f172a] border-r border-slate-800 flex flex-col text-slate-100 shadow-2xl z-20 font-sans">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar px-4 py-4">
        ...
        {selectedItem ? (
           <div className="p-4 bg-slate-800/40 rounded-xl border border-slate-700/50 mb-6 animate-in fade-in slide-in-from-left-4 duration-300 shadow-lg">
              <h3 className="font-bold text-white mb-3 flex items-center gap-2 text-xs uppercase tracking-wide border-b border-slate-700/50 pb-2">
          ...
          <div className="p-8 text-center text-slate-500 text-xs border-2 border-dashed border-slate-800 rounded-xl mb-6 bg-slate-800/20">
            <Box className="mx-auto mb-2 opacity-20" size={32}/>
            Selecione uma posição<br/>para ver detalhes.
          </div>
        )}
      ...
      <div className="p-4 bg-[#0b1120] border-t border-slate-800 text-xs space-y-4 shadow-[0_-10px_40px_rgba(0,0,0,0.5)] z-30">
         ...
         <div className="grid grid-cols-2 gap-2 pt-3 border-t border-slate-800/50">
            <div className="bg-slate-900/50 rounded px-2 py-1 flex justify-between"><span className="text-slate-500">Ocupado</span> <span className="text-orange-400 font-semibold">{stats.occupied}</span></div>
            <div className="bg-slate-900/50 rounded px-2 py-1 flex justify-between"><span className="text-slate-500">Livre</span> <span className="text-green-400 font-semibold">{stats.available}</span></div>
            <div className="bg-slate-900/50 rounded px-2 py-1 flex justify-between"><span className="text-slate-500">Bloq</span> <span className="text-slate-400 font-semibold">{stats.blocked}</span></div>
            <div className="bg-slate-900/50 rounded px-2 py-1 flex justify-between"><span className="text-slate-500">Reserva</span> <span className="text-yellow-400 font-semibold">{stats.reserved}</span></div>
         </div>
